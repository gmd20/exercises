...
call s:hi("DiffAdd",    s:gui.background,        s:gui.green,       "", "", "")
call s:hi("DiffChange", s:gui.background,        s:gui.yellow,       "", "", "")
call s:hi("DiffDelete", s:gui.background,        s:gui.red, "", "", "")
call s:hi("DiffText",   s:gui.background,        s:gui.orange,  "", "", "")
...
" call s:hi("Search",      s:gui.background,   s:gui.light_yellow,       "", "", "underline")
